...
namespace CaseGame.Environment
{
    ...
    /// needs to procedurally reassemble the island for any grid size: 9 for the grass layer
    /// (4 corners, 4 edges, 1 repeating center — the same "9-slice" shape already used by the
    /// Tiny Swords tileset's own Flat/Elevated Ground pieces) and 3 for the cliff row beneath
    /// the bottom edge (left corner, repeating middle, right corner). A designer can override
    /// any individual piece by hand, same as any other SO-driven configuration here.
    /// </summary>
