...
namespace CaseGame.Buildings
{
    ...
    /// instance, but through different code paths. Placement subscribes to actually perform
    /// the removal; Selection subscribes to clear a stale selection if the removed building
